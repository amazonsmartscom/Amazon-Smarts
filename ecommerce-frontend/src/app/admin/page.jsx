...
//         {/* 🚀 🚀 NEW: HOMEPAGE BANNER MANAGEMENT 🚀 🚀 */}
...
//               <button type="submit" disabled={isBannerUploading} className="w-full bg-slate-900 text-white font-black py-4 rounded-xl hover:bg-orange-500 transition-all uppercase text-xs tracking-widest shadow-md">
...
//                         </div>
//                         <button onClick={() => handleDeleteBanner(banner._id)} className="bg-red-50 text-red-500 p-2 rounded-lg hover:bg-red-500 hover:text-white transition-colors">🗑️</button>
//                       </div>
//                     </div>
//                   ))}
//                </div>
...
//       if (results[6].status === 'fulfilled' && results[6].value.data) {
//         setSignupBonus(results[6].value.data.signupBonus || 0);
//         setNewUserBonus(results[6].value.data.newUserBonus || 0);
//       }
...
//   const handleSaveGlobalSettings = async () => {
//     try {
//       await axios.put(`${process.env.NEXT_PUBLIC_API_URL}/auth/settings`, { signupBonus, newUserBonus });
//       alert("✅ Global Bonus Settings Updated!");
//     } catch (error) {
//       alert("Failed to update global settings.");
//     }
//   };
...
//                {/* 🚀 UPDATED GLOBAL SETTINGS CARD */}
//                <div className="bg-white border border-[#DDD] rounded-[4px] p-6 mb-8 shadow-sm grid grid-cols-1 md:grid-cols-2 gap-6">
//                   {/* Referrer Bonus */}
//                   <div>
//                     <h3 className="text-[16px] font-bold text-[#111]">Referrer Reward (₹)</h3>
//                     <p className="text-[12px] text-[#565959] mb-3">Amount given to the person who shared their link.</p>
//                     <div className="flex items-center gap-3">
//                       <input 
//                         type="number" 
//                         className={amzInput + " w-24 text-lg font-bold !py-1.5 text-center"} 
...
//                   {/* New User Bonus */}
//                   <div>
//                     <h3 className="text-[16px] font-bold text-[#111]">New User Welcome Bonus (₹)</h3>
//                     <p className="text-[12px] text-[#565959] mb-3">Amount given to a new user when they verify their account.</p>
//                     <div className="flex items-center gap-3">
//                       <input 
//                         type="number" 
//                         className={amzInput + " w-24 text-lg font-bold !py-1.5 text-center"} 
...
//                   {/* Save Button */}
//                   <div className="md:col-span-2 border-t border-[#EEE] pt-4 mt-2 text-right">
//                     <button onClick={handleSaveGlobalSettings} className={amzYellowBtn + " px-8 py-2"}>Save All Settings</button>
//                   </div>
//                </div>
...
//           {/* INVENTORY TAB 🚀 DATES FORMATTED WITH TIME */}
//           {activeTab === 'inventory' && (
//             <div className="max-w-[1600px] mx-auto">
//                <div className="flex justify-between items-center mb-6">
//                   <h2 className="text-[22px] font-bold">Inventory Management</h2>
...
//                           <td className="p-3 border-r border-[#DDD] whitespace-nowrap">
//                             <div className="text-[11px] text-[#565959] mb-1"><span className="font-bold text-[#111]">Added:</span> {formatDateTime(p.createdAt)}</div>
//                             <div className="text-[11px] text-[#565959]"><span className="font-bold text-[#111]">Updated:</span> {formatDateTime(p.updatedAt)}</div>
//                           </td>
...
//           {/* ORDERS TAB 🚀 DATES FORMATTED WITH TIME */}
//           {activeTab === 'orders' && (
//             <div className="max-w-[1600px] mx-auto">
//                <h2 className="text-[22px] font-bold mb-6">Order Fulfillment</h2>
//                <div className="bg-white border border-[#DDD] rounded-[4px] overflow-hidden shadow-sm">
...
//                             <p className="text-[11px] text-[#565959] mt-1">{formatDateTime(o.createdAt)}</p>
//                           </td>
//                           <td className="p-3 border-r border-[#DDD]">
//                              <p className="font-bold text-[#007185]">{o.shippingAddress?.fullName}</p>
//                              {o.shippingAddress && (
...
//           {/* PAYOUTS TAB 🚀 DATES FORMATTED WITH TIME */}
//           {activeTab === 'payouts' && (
//             <div className="max-w-[1200px] mx-auto">
//                <h2 className="text-[22px] font-bold mb-6">Affiliate Payouts & Settings</h2>
...
//                       {withdrawals.map((req) => (
//                         <tr key={req._id} className="hover:bg-[#F9F9F9]">
//                           <td className="p-4 border-r border-[#DDD] font-bold text-[#111]">
//                             {req.userId?.name}
//                             <div className="text-[10px] text-[#565959] font-normal mt-1">{formatDateTime(req.createdAt)}</div>
//                           </td>
//                           <td className="p-4 border-r border-[#DDD] font-bold text-[#007600]">₹{req.amount?.toLocaleString()}</td>
//                           <td className="p-4 border-r border-[#DDD]">
//                             {req.details?.upiId ? (
...
//           {/* MARKETING TAB 🚀 DATES FORMATTED WITH TIME */}
//           {activeTab === 'marketing' && (
//             <div className="max-w-[1200px] mx-auto">
//                <h2 className="text-[22px] font-bold mb-6">Storefront Content</h2>
//                <div className="bg-white border border-[#DDD] rounded-[4px] shadow-sm overflow-hidden">
...
//           {/* REVIEWS TAB 🚀 DATES FORMATTED WITH TIME */}
//           {activeTab === 'reviews' && (
//             <div className="max-w-[1200px] mx-auto">
//                <h2 className="text-[22px] font-bold mb-6">Customer Feedback Moderation</h2>
//                <div className="bg-white border border-[#DDD] rounded-[4px] shadow-sm overflow-hidden">
...
//                         <tr key={item.review._id} className="hover:bg-[#F9F9F9] align-top">
//                           <td className="p-4 border-r border-[#DDD]">
//                             <span className="font-bold text-[#111]">{item.productName}</span>
//                             <p className="text-[11px] text-[#007185] mt-1 hover:underline cursor-pointer">by {item.review.name}</p>
//                             <p className="text-[10px] text-[#565959] mt-0.5">{formatDateTime(item.review.createdAt || item.review.updatedAt || new Date())}</p>
//                           </td>
//                           <td className="p-4 border-r border-[#DDD] italic"><div className="text-[#e77600] text-sm mb-1">{'★'.repeat(item.review.rating)}{'☆'.repeat(5 - item.review.rating)}</div>"{item.review.comment}"</td>
//                           <td className="p-4 text-right space-x-3">
//                              <button onClick={() => handleReviewAction(item.productId, item.review._id, 'approved')} className="text-green-700 font-bold text-[11px] hover:underline">APPROVE</button>
...
//   const [newCoupon, setNewCoupon] = useState({ code: '', discountType: 'percentage', discountValue: '', minPurchaseAmount: '', expiresAt: '' });
...
//         axios.get(`${apiUrl}/admin/stats`, config),
//         axios.get(`${apiUrl}/auth/settings`),
//         axios.get(`${apiUrl}/coupons`, config) // 🚀 FETCH COUPONS
//       ]);
...
//         setCoupons(results[7].value.data);
//       }
...
//       setNewCoupon({ code: '', discountType: 'percentage', discountValue: '', minPurchaseAmount: '', expiresAt: '' });
//       fetchDashboardData();
//     } catch (error) {
...
//     try {
//       await axios.patch(`${process.env.NEXT_PUBLIC_API_URL}/coupons/${id}/toggle?adminId=${adminId}`);
//       fetchDashboardData();
//     } catch (error) {
...
//     try {
//       await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}/coupons/${id}?adminId=${adminId}`);
//       fetchDashboardData();
//     } catch (error) {
...
//                     <div>
//                       <label className={amzLabel}>Coupon Code</label>
//                       <input type="text" placeholder="e.g. SUMMER50" className={`${amzInput} uppercase`} value={newCoupon.code} onChange={e => setNewCoupon({...newCoupon, code: e.target.value})} required />
//                     </div>
//                     <div>
//                       <label className={amzLabel}>Discount Type</label>
//                       <select className={amzInput} value={newCoupon.discountType} onChange={e => setNewCoupon({...newCoupon, discountType: e.target.value})}>
//                         <option value="percentage">Percentage (%)</option>
//                         <option value="fixed">Flat Amount (₹)</option>
//                       </select>
//                     </div>
//                     <div>
//                       <label className={amzLabel}>Discount Value</label>
//                       <input type="number" placeholder="e.g. 20" className={amzInput} value={newCoupon.discountValue} onChange={e => setNewCoupon({...newCoupon, discountValue: e.target.value})} required />
//                     </div>
//                     <div>
//                       <label className={amzLabel}>Min. Purchase (₹)</label>
//                       <input type="number" placeholder="e.g. 999" className={amzInput} value={newCoupon.minPurchaseAmount} onChange={e => setNewCoupon({...newCoupon, minPurchaseAmount: e.target.value})} />
//                     </div>
//                     <div className="flex gap-2">
//                       <button type="submit" disabled={isCreatingCoupon} className={`${amzYellowBtn} w-full`}>{isCreatingCoupon ? '...' : 'Create'}</button>
//                     </div>
//                   </form>
//                </div>
...
//                     <thead className="bg-[#F0F2F2] border-b border-[#DDD] font-bold text-[#565959]">
//                       <tr>
//                         <th className="p-3 border-r border-[#DDD]">Code</th>
//                         <th className="p-3 border-r border-[#DDD]">Discount</th>
//                         <th className="p-3 border-r border-[#DDD]">Min Purchase</th>
//                         <th className="p-3 border-r border-[#DDD]">Status</th>
//                         <th className="p-3 text-right">Action</th>
//                       </tr>
//                     </thead>
...
//                         return (
//                           <tr key={coupon._id} className={`hover:bg-[#F9F9F9] align-middle ${!coupon.isActive || isExpired ? 'opacity-60' : ''}`}>
//                             <td className="p-3 border-r border-[#DDD]">
//                               <p className="font-mono font-bold text-[#111] text-[15px] bg-[#f0f2f2] px-2 py-0.5 inline-block border border-[#ddd] rounded">{coupon.code}</p>
//                               <p className="text-[10px] text-[#565959] mt-1">Added: {new Date(coupon.createdAt).toLocaleDateString()}</p>
//                             </td>
//                             <td className="p-3 border-r border-[#DDD] font-bold text-[#007185]">
...
//                                 className={`text-[10px] font-bold uppercase px-2 py-1 rounded-[3px] border ${coupon.isActive && !isExpired ? 'bg-[#e7f4e4] text-[#007600] border-[#007600]' : 'bg-[#fce8e6] text-[#B12704] border-[#B12704]'}`}
//                               >
//                                 {isExpired ? 'Expired' : coupon.isActive ? 'Active' : 'Paused'}
//                               </button>
//                             </td>
//                             <td className="p-3 text-right">
//                                <button className="text-[#B12704] hover:underline font-bold" onClick={() => handleDeleteCoupon(coupon._id)}>Delete</button>
//                             </td>
//                           </tr>
//                         )
//                       })}
...
//     minPurchaseAmount: '', expiresAt: '', applicableProducts: [] // 🚀 Added applicableProducts
//   });
//   const [isCreatingCoupon, setIsCreatingCoupon] = useState(false);
...
//                               checked={newCoupon.applicableProducts.includes(p._id)}
//                               onChange={() => handleProductCheckbox(p._id)}
//                             />
...
//                     <div className="flex justify-end border-t border-[#eee] pt-4">
//                       <button type="submit" disabled={isCreatingCoupon} className={`${amzYellowBtn} px-10`}>{isCreatingCoupon ? 'Creating...' : 'Create Promo Code'}</button>
//                     </div>
//                   </form>
//                </div>
...
//                       <tr>
//                         <th className="p-3 border-r border-[#DDD]">Code</th>
//                         <th className="p-3 border-r border-[#DDD]">Discount Details</th>
//                         <th className="p-3 border-r border-[#DDD]">Rules & Restrictions</th>
//                         <th className="p-3 border-r border-[#DDD]">Status</th>
//                         <th className="p-3 text-right">Action</th>
//                       </tr>
//                     </thead>
...
//                             </td>
//                             <td className="p-3 border-r border-[#DDD]">
//                               <p className="text-[#111]"><span className="font-bold">Min Purchase:</span> {coupon.minPurchaseAmount > 0 ? `₹${coupon.minPurchaseAmount}` : 'No Minimum'}</p>
//                               <p className="text-[11px] text-[#565959] mt-1">
//                                 <span className="font-bold text-[#111]">Applies to:</span> {appliesToAll ? 'Entire Store' : `${coupon.applicableProducts.length} specific product(s)`}
//                               </p>
//                             </td>
//                             <td className="p-3 border-r border-[#DDD]">
//                               <button 
...
//       <div className="min-h-screen bg-[#131921] flex items-center justify-center p-4">
//         <div className="bg-white rounded-[8px] p-10 w-full max-w-md shadow-2xl">
//           <div className="text-center mb-8"><h1 className="text-2xl font-normal tracking-tighter">amazon<span className="font-bold text-[#febd69]">seller central</span></h1><p className="text-[12px] font-bold mt-1 uppercase text-[#565959]">Secure Login</p></div>
//           {loginError && <div className="bg-red-50 text-red-600 p-3 rounded text-[13px] mb-6 border border-red-100">{loginError}</div>}
//           <form onSubmit={handleAdminLoginSubmit} className="space-y-4">
//             <div><label className={amzLabel}>Admin Email</label><input type="email" required className={amzInput} value={adminEmail} onChange={(e) => setAdminEmail(e.target.value)} /></div>
//             <div><label className={amzLabel}>Password</label><input type="password" required className={amzInput} value={adminPassword} onChange={(e) => setAdminPassword(e.target.value)} /></div>
...
//       <header className="bg-[#131921] text-white px-6 py-2.5 flex justify-between items-center sticky top-0 z-[100]">
//         <div className="flex items-center gap-8">
//           <Link href="/"><h1 className="text-xl font-normal tracking-tighter">amazon<span className="text-[#febd69] font-bold">seller central</span></h1></Link>
//           <div className="hidden lg:flex gap-6 text-[13px] font-bold">
//             <button onClick={() => setActiveTab('dashboard')} className={activeTab === 'dashboard' ? 'text-[#febd69]' : 'hover:text-[#febd69]'}>Home</button>
//             <button onClick={() => setActiveTab('inventory')} className={activeTab === 'inventory' ? 'text-[#febd69]' : 'hover:text-[#febd69]'}>Inventory</button>
//             <button onClick={() => setActiveTab('orders')} className={activeTab === 'orders' ? 'text-[#febd69]' : 'hover:text-[#febd69]'}>Orders</button>
...
//           </div>
//         </div>
//         <div className="flex items-center gap-4 text-[12px]"><span className="opacity-70">Store: Amazon Smarts</span><button onClick={logout} className="hover:underline text-[#febd69] font-bold">Sign Out</button></div>
//       </header>
...
//           {activeTab === 'inventory' && (
//             <div className="max-w-[1600px] mx-auto">
//                <div className="flex justify-between items-center mb-6"><h2 className="text-[22px] font-bold">Inventory Management</h2><button onClick={() => setActiveTab('add-product')} className={amzYellowBtn}>+ Add New</button></div>
//                <div className="bg-white border border-[#DDD] rounded-[4px] overflow-hidden shadow-sm">
//                   <table className="w-full text-left text-[13px]">
//                     <thead className="bg-[#F0F2F2] border-b border-[#DDD] font-bold text-[#565959]">
//                       <tr>
...
export default function AdminDashboard() {
  ...
  const handleExportCSV = () => {
    ...
    const rows = filteredOrders.map(o => [
      ...
      `"${o.shippingAddress?.fullName || 'N/A'}"`,
      `"${o.shippingAddress?.phone || 'N/A'}"`,
      `"${o.orderItems?.map(i => `${i.quantity || i.qty}x ${i.name} ${i.isCancelled ? '(Cancelled)' : ''}`).join(' | ')}"`,
      o.totalPrice,
      `"${o.paymentMethod === 'COD' || o.paymentMethod === 'Cash on Delivery' ? 'COD' : 'PREPAID'}"`,
      `"${o.status}"`
    ]);
                    ...
                    {filteredOrders.map(o => (
                      <tr key={o._id} className={`hover:bg-[#F9F9F9] align-top ${o.status === 'Cancelled' ? 'opacity-70 bg-gray-50' : ''}`}>
                        ...
                        <td className="p-4 border-r border-[#DDD]">
                          <div className="space-y-3">
                            {o.orderItems?.map((i, idx) => (
                              <div key={i._id || idx} className={`text-[11px] flex gap-3 p-2 rounded ${i.isCancelled ? 'bg-red-50/50 opacity-60 grayscale' : ''}`}>
                                <div className="w-10 h-10 bg-gray-100 border border-gray-200 rounded flex-shrink-0 flex items-center justify-center relative">
                                  <span className="text-xl">📦</span>
                                  {i.isCancelled && <span className="absolute text-red-600 text-2xl font-bold">✕</span>}
                                </div>
                                <div className="flex-1">
                                  <div className="flex justify-between items-start">
                                    ...
                                    {i.isCancelled ? (
                                      ...
                                      o.status === 'Processing' && !o.shippingDetails?.trackingId && (
                                        <button 
                                          onClick={() => handleCancelSingleItem(o._id, i._id)} 
                                          className="text-[#B12704] hover:bg-red-50 px-1 py-0.5 rounded text-[10px] font-bold ml-2 shrink-0 border border-transparent hover:border-[#B12704] transition-colors"
                                        >
                                          ✕ Cancel
                                        </button>
                                      )
                            ...
                            {o.shippingDetails?.trackingId ? (
                              ...
                              <div className="space-y-2">
                                ...
                                <button onClick={async () => {
                                  ...
                                  }} className="w-full text-red-600 font-bold text-[10px] py-1 text-center hover:underline">🚫 Cancel Entire Order</button>
                              </div>
                            ) : null}
                          </div>
                        </td>
